(function () {
  ...
  const initNeonDreams = (disableGlow, obs) => {
    ...
    if (!disableGlow) {
      /* replace neon red */
      updatedThemeStyles = updatedThemeStyles.replace(/color: #fe4450;/g, "color: #ff2f2f; text-shadow: 0 0 7px #2b0808, 0 0 1px #b30404, 0 0 3px #f90336, 0 0 2px #bf0808; backface-visibility: hidden;");

      /* replace neon pink */
      updatedThemeStyles = updatedThemeStyles.replace(/color: #ff7edb;/g, "color: #e7d8f7; text-shadow:0 0 6px #6900c5, 0 0 1px #8656c1, 0 0 3px #4b1494, 0 0 2px #3d1048; backface-visibility: hidden;");
      ...
      updatedThemeStyles = updatedThemeStyles.replace(/color: #fede5d;/g, "color: #ffbfe6; text-shadow:0 0 7px #ff04b2, 0 0 1px #f768bc, 0 0 3px #d83697, 0 0 2px #ff73c7; backface-visibility: hidden;");

      /* replace green */
      updatedThemeStyles = updatedThemeStyles.replace(/color: #72f1b8;/g, "color: #65f5a5; text-shadow:0 0 5px #2c861c, 0 0 1px #084214, 0 0 3px #484605, 0 0 2px #64ff02; font-family: 'Operator Mono'; font-size: 15px; backface-visibility: hidden;");

      /* replace blue */
      updatedThemeStyles = updatedThemeStyles.replace(/color: #36f9f6;/g, "color: #34ebdd; text-shadow: 0 0 7px #001716, 0 0 1px #0321f9, 0 0 3px #03edf9, 0 0 2px #0d2fd4;backface-visibility: hidden");
    }
